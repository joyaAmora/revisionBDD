...
create table TAXE(
        codeTx  char(6) not null,
        TPS     decimal(5,4) not null,
        TVQ     decimal(5,4) not null,
        primary key (codeTx))
ENGINE = INNODB;
...
create table COMMANDE (
        ...
        totalSansTx DECIMAL(10,2),
        payee    boolean,
        livree   boolean,
        codeTx   char(6),
        primary key (NCOM),
      	foreign key (NCLI) references CLIENT(NCLI),
        FOREIGN key (codeTx) REFERENCES TAXE(codeTx))
ENGINE = INNODB;
...
insert into CLIENT values ('B112','HANSENNE','23, r. Dumont','Poitiers','C1',1250);
...
insert into CLIENT values ('F011','PONCELET','17, Cles des Erables','Toulouse','B2',0);
...
insert into PRODUIT values ('CS262','CHEV. SAPIN 200x6x2',75,45,100,3000);
insert into PRODUIT values ('CS264','CHEV. SAPIN 200x6x4',120,2690,100,3000);
insert into PRODUIT values ('CS464','CHEV. SAPIN 400x6x4',220,450,100,3000);
insert into PRODUIT values ('PA45' ,'POINTE ACIER 45 (1K)',105,580,100,3000);
insert into PRODUIT values ('PA60' ,'POINTE ACIER 60 (1K)',95,134,100,3000);
insert into PRODUIT values ('PH222','PL. HETRE 200x20x2',230,782,100,3000);
insert into PRODUIT values ('PS222','PL. SAPIN 200x20x2',185,1220,100,3000);

insert into TAXE VALUES ('TX2019', 0.05, 0.09975);

insert into COMMANDE values ('30178','K111','2015-12-21', 0, 0, 0, 'TX2019');
insert into COMMANDE values ('30179','C400','2015-12-22', 0, 0, 0, 'TX2019');
insert into COMMANDE values ('30182','S127','2015-12-23', 0, 1, 0, 'TX2019');
insert into COMMANDE values ('30184','C400','2015-12-23', 0, 0, 0, 'TX2019');
insert into COMMANDE values ('30185','F011','2016-01-02', 0, 0, 0, 'TX2019');
insert into COMMANDE values ('30186','C400','2016-01-02', 0, 1, 1, 'TX2019');
insert into COMMANDE values ('30188','B512','2016-01-03', 0, 0, 0, 'TX2019');
